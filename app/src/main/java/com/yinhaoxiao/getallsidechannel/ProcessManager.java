...
public class ProcessManager {
    ...
    public static Process getParticularProcessInfo(int pid) throws Exception {
        String line = Shell.SH.run("toolbox ps -p -P -x -c " + pid).get(1);
        return new Process(line);
    }

    public static Process getParticularProcessInfo(String packagename) throws Exception {
        String line = Shell.SH.run("toolbox ps -p -P -x -c " + packagename).get(1);
        return new Process(line);
    }
